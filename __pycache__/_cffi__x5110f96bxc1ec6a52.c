...
static PyObject *
_cffi_f_diff(PyObject *self, PyObject *args)
{
  double x0;
  double x1;
  double result;
  ...
  if (!PyArg_ParseTuple(args, "OO:diff", &arg0, &arg1))
    return NULL;
...
static PyObject *
_cffi_f_distance(PyObject *self, PyObject *args)
{
  double x0;
  double x1;
  double x2;
  ...
  if (!PyArg_ParseTuple(args, "OOOO:distance", &arg0, &arg1, &arg2, &arg3))
    return NULL;
...
static PyMethodDef _cffi_methods[] = {
  {"diff", _cffi_f_diff, METH_VARARGS},
  {"distance", _cffi_f_distance, METH_VARARGS},
  {"_cffi_setup", _cffi_setup, METH_VARARGS},
  {NULL, NULL}    /* Sentinel */
};

PyMODINIT_FUNC
init_cffi__x5110f96bxc1ec6a52(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x5110f96bxc1ec6a52", _cffi_methods);
  if (lib == NULL || 0 < 0)
    return;
  _cffi_init();
  return;
